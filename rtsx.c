...
MODULE_DESCRIPTION("Realtek PCI-Express card reader rts5286/5287/5289 driver");
MODULE_LICENSE("GPL");
...
static const struct pci_device_id rtsx_ids[] = {
	{ PCI_DEVICE(PCI_VENDOR_ID_REALTEK, 0x5286),
		PCI_CLASS_OTHERS << 16, 0xFF0000 },
	{ PCI_DEVICE(PCI_VENDOR_ID_REALTEK, 0x5287),
		PCI_CLASS_OTHERS << 16, 0xFF0000 },
	{ PCI_DEVICE(PCI_VENDOR_ID_REALTEK, 0x5289),
		PCI_CLASS_OTHERS << 16, 0xFF0000 },
	{ 0, },
};
